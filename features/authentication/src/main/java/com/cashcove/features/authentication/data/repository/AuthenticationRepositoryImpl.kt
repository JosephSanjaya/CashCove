...
class AuthenticationRepositoryImpl(
    ...
    override suspend fun verifyOtp(request: VerifyOtpRequestDTO): UiState<VerifyOtpResponseDTO> =
    ...
    override suspend fun changePhoneSendOtp(
    ...
    override suspend fun changePhoneVerifyOtp(
    ...
    override suspend fun onboarding(): UiState<OnboardingResponseDTO> =
        safeApiCall { authenticationService.onboarding() }
}
